...
<html lang="en">
  <head>
    ...
    <title>Projeto mobile firts</title>
  ...
  <body>
    <header>
      <div class="content">
        <nav>
          <p class="brand">Henrique <strong>Fernandes</strong></p>
          <ul>
        ...
        <div class="content footer-links">
          ...
          <div class="footer-social">
            ...
            <div class="social-icons">
              <img src="images/instagram.png" alt="Instagram" href="https://www.instagram.com/henrique_hfr/"/>
              <img src="images/facebook.png" alt="Facebook" />
            </div>
          </div>
          <div class="footer-contact">
            <h4>Contact BR</h4>
            <h6>+55 11 99525-9291</h6>
            <h6>fernandes4626@gmail.com</h6>
            <h6>Rua tal, Bairro tal, Guarulhos</h6>
          </div>
        </div>
      </div>
      <div class="last">&copy Projeto  2021</div>
    </footer>
  </body>
</html>
